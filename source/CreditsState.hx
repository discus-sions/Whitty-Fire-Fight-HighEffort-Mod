...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Mod Creator'],
			['Discussions', 		'discussions', 		'The Only Coder that Created this Mod.', 			    'https://gamebanana.com/members/1900848','57E88A'],
			['Originally By'],
			['Trake', 'trake', 'The person who is locked in my baseme--I mean, the one who orginally made the mod.', 'https://gamebanana.com/members/1900555','5FF8D18'], //I give credit :)
			['Psych Engine Team'],
