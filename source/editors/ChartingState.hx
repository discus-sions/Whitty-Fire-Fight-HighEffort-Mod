...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Healh Trouble', "Value 1: 1 = Dad, 0 = BF\nValue 2: Value of Health Drain (True/False)"], //my three events that helped this thing come to life. Made events so its easier lol
		['Health Brain', "Value 1: 0 = Drain, 1 = Gain\nValue 2: Amount of Health to Gain/Drain. \n(Max Health is 2, Middle 1, and none is 0.)"],
		['Drain Amount', "Value 1: 1 = Dad, 0 = BF\nValue 2: Value of New Drain Value."], 
	];
